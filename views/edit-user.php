    ...
    <main class="row justify-content-center gx-0">
        <div class="col-4">
            ...
            <form action="../actions/edit-user.php" method="post" enctype="multipart/form-data">
                <!-- enctype: encoding type -- attribute that controls the behavior of the form submission -->
                <!-- multipart/form-data is used if the form contains a file upload/ input type = "file" -->
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="first_name" class="form-control" value="<?= $user['first_name'] ?>" required autofocus">
                </div>
                <div class="mb-3">
